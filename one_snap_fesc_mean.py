...
ax1 = axes[0, 0]
mask_lum = lum > 0
ax1.scatter(Llambda_to_M1500(lum[mask_lum]), fesc_avg[mask_lum], 
            alpha=0.3, s=20, label='lum (sim)', color='blue')

mask_lum1500 = lum1500 > 0
ax1.scatter(Llambda_to_M1500(lum1500[mask_lum1500]), fesc_avg[mask_lum1500], 
            alpha=0.3, s=20, label='lum1500 (sim)', color='cyan')
...
# Subplot 2: Masses
ax2 = axes[0, 1]
ax2.scatter(mstar, fesc_avg, alpha=0.3, s=20, label='mstar (sim)', color='red')
ax2.scatter(mvir, fesc_avg, alpha=0.3, s=20, label='mvir (sim)', color='orange')
ax2.scatter(minit, fesc_avg, alpha=0.3, s=20, label='minit (sim)', color='pink')
...
ax3 = axes[1, 0]
ax3.scatter(stellar_Zlw, fesc_avg, alpha=0.3, s=20, 
           label='stellar_Zlw (sim)', color='green')
ax3.scatter(stellar_Zmw, fesc_avg, alpha=0.3, s=20, 
...
ax4 = axes[1, 1]
ax4.scatter(sfr1, fesc_avg, alpha=0.3, s=20, label='sfr1 (sim)', color='purple')
ax4.scatter(sfr3, fesc_avg, alpha=0.3, s=20, label='sfr3 (sim)', color='violet')
ax4.scatter(sfr10, fesc_avg, alpha=0.3, s=20, label='sfr10 (sim)', color='magenta')
ax4.scatter(sfr100, fesc_avg, alpha=0.3, s=20, label='sfr100 (sim)', color='orchid')
...
logging.info(f"\nPlot saved as: AVERAGED_fesc_analysis_with_obs_{snapshot}.png")
